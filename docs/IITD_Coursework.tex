...
\item \textbf{COL774 Machine Learning} {\color{red}Audit-Pass}
    ...
    \\
    \textit{Remarks}: WORST COURSE EVER. 0/10 would not recommend. All the grading was based on a silly assignment and aribitrary awarded Class Participation Marks. 
\end{itemize}
\end{document}
